...
namespace Vehicles.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("79797138", "Johnny", "Gutiérrez", "jogutiro@yopmail.com", "304 379 8420", "Villas de la Florida", UserType.Admin);
        }
        ...
        private async Task CheckVehiclesTypeAsync()
        {
            if (!_context.VehicleTypes.Any())
            {
                ...
                _context.VehicleTypes.Add(new VehicleType { Description = "CAMPERO" });
                ...
                _context.VehicleTypes.Add(new VehicleType { Description = "MICROBUS" });
                _context.VehicleTypes.Add(new VehicleType { Description = "TRACTOCAMION" });
                _context.VehicleTypes.Add(new VehicleType { Description = "MOTOCICLETA" });
                _context.VehicleTypes.Add(new VehicleType { Description = "MOTOCARRO" });
                _context.VehicleTypes.Add(new VehicleType { Description = "VOLQUETA" });
                await _context.SaveChangesAsync();
            }
        }
    }
